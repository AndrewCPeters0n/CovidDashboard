...
import pandas as pd
import numpy as np
# Run ScrapeWebsite.py in order to get new data



# Load the last three json files of data using pandas
df1 = pd.read_json(r"C:\Users\lopez\Desktop\CovidDashboard-main\covid_data_2022-12-02.json")
df2 = pd.read_json(r"C:\Users\lopez\Desktop\CovidDashboard-main\covid_data_2022-12-01.json")
df3 = pd.read_json(r"C:\Users\lopez\Desktop\CovidDashboard-main\covid_data_2022-12-10.json")
...
df4 = pd.read_csv('updated_countries.csv',encoding='latin-1')
...
country_names = df1["Country"].head(10)
total_deaths1 = df1['Total Deaths'].head(10)
total_deaths2 = df2['Total Deaths'].head(10)
total_deaths3 = df3['Total Deaths'].head(10)
df1['Date'] = pd.to_datetime(df1['Date'])
df2['Date'] = pd.to_datetime(df2['Date'])
df3['Date'] = pd.to_datetime(df3['Date'])
p2.circle([df1['Date'][0],df2['Date'][0],df3['Date'][0]],[total_deaths1[0], total_deaths2[0],total_deaths3[0]],fill_color='red',size=8,legend_label=df1['Country'][0])
p2.circle([df1['Date'][0],df2['Date'][0],df3['Date'][0]],[total_deaths1[1], total_deaths2[1],total_deaths3[1]],fill_color='orange',size=8,legend_label=df1['Country'][1])
p2.circle([df1['Date'][0],df2['Date'][0],df3['Date'][0]],[total_deaths1[2], total_deaths2[2],total_deaths3[2]],fill_color='yellow',size=8,legend_label=df1['Country'][2])
p2.circle([df1['Date'][0],df2['Date'][0],df3['Date'][0]],[total_deaths1[3], total_deaths2[3],total_deaths3[3]],fill_color='green',size=8,legend_label=df1['Country'][3])
p2.circle([df1['Date'][0],df2['Date'][0],df3['Date'][0]],[total_deaths1[4], total_deaths2[4],total_deaths3[4]],fill_color='blue',size=8,legend_label=df1['Country'][4])
